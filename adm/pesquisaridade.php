<?php $categoriaida = $_POST['categoriaida'];?>
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="assets/img/favicon.ico">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

	<title>Categoria:<?php echo $categoriaida?></title>
...
include_once("../fun/conexao.php");
	...
	$result_cursos = "SELECT * FROM usuarios WHERE categoriaida='$categoriaida' AND niveis_acesso_id='0' ORDER BY id ASC";
	...
	$i=0;
			...
			<thead>
			<tr>
			    <h1>Filtro Realizado por Faixa: $categoriaida</td>
			</tr>
        <tr>
