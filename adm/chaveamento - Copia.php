...
<?php
	...
	$sql = "SELECT id,nome,equipe FROM usuarios WHERE faixa='$faixa' and categoriaida='$categoriaida' and categoriapeso='$categoriapeso' and sexo='$sexo' and niveis_acesso_id=0 ";
