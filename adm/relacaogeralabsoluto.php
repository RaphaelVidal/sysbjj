...
<?php
	...
	$faixa = array( 1 => 'BRANCA', 2 => 'AZUL', 3 => 'ROXA', 4 => 'MARROM', 5 => 'PRETA' );
...
for($s=1;$s<=2;$s++){
	/*echo $sexo[$s];
	echo'</br>';*/	
			for($f=1;$f<=3;$f++){ //faixas
				/*echo'<p>';
				echo'</br>';
				echo $faixa[$f];
				echo'</p>';*/
							
	$result_cursos = "SELECT * FROM usuarios WHERE faixa='$faixa[$f]' and sexo='$sexo[$s]' and niveis_acesso_id=0 and `competir` LIKE  '%absoluto%' ORDER BY id ASC";
