...
<?php
	...
	$result_cursos = "SELECT * FROM usuarios WHERE faixa='$faixa' AND categoriapeso='$categoriapeso' AND sexo='$sexo' AND categoriaida='$categoriaida' ORDER BY id ASC";
