<?php $faixa= $_POST['faixa'];
	  $sexo= $_POST['sexo'];
?> <!--recebe o valor selecionado da faixa e sexo-->
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="assets/img/favicon.ico">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

	<title>Faixa:<?php echo $faixa?></title>
...
include_once("../fun/conexao.php");
	...
	$result_cursos = "SELECT * FROM usuarios WHERE faixa='$faixa' and niveis_acesso_id=0 and competir like'%Categoria_e_Absoluto%' and sexo like'%$sexo%' ORDER BY id ASC";
	...
	$i=0;
			...
			<thead>
			<tr>
			    <h1>Absoluto Faixa $faixa $sexo</td>
			</tr>
        <tr>
