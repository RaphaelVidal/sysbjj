			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="header header-success btn-lg text-center">
									<h4><b>Cadastro de Professor</b></h4>
									<h5>Este Cadastro tem como objetivo acompanhar as informações sobre a sua equipe no campeonato</h5>
									</div>
			<div align="center">
			<center>
		
		
		<form name="formuser" action="processa_cad_prof.php" method="POST">
