        ...
        <div class="content">
            <div class="container-fluid">
			 ...
			 <div class="texto" >
				 ...
				 <center><h1>Como realizar pagamento?</h1></center><br>
                      <p><b>Passo 1:</b> Realize o depósito na <b>Conta Corrente 0609650-6 / Agência 0456 / Banco Bradesco</p><p align="center"> <br>Valor: categoria = 30,00 R$   /  categoria e Absoluto = 50,00 R$</b>. </p><br>
					  <p><b>Passo 2:</b> Na opção abaixo anexar a copia digital do comprovante de depósito ou tire uma foto (com boa qualidade). </p><br>
					  <p><b><font color="red">Atenção:</font> Imprima e leve o comprovante de deposito no dia da competição.</b>  </p><hr>
                    
              </div><!-- Fim Texto -->
                 <form class="formuser" enctype="multipart/form-data"  method="POST" action="update_comprov.php?cpf=<?php echo  $cpf?>" >
			...
			<center>	
					<div align="center"><h2>Anexar comprovante de depósito</h2>
			<table id="cad_table" >
				
				<tr>
				<td class="btn-lg text-right" >Comprovante:</td>
				<td align="center" width="%" height=""><img width="400px" align="center" height="400px" src="comprovantes/<?php echo $cpf;?>.jpg" type="text"  name="arquivo"  > </td>
				</tr>
				
				<td class="btn-lg text-right">Anexar imagem :</td><td> <input  required name="arquivo" type="file" />  </td>
				</tr>
				...
				<input align="center" type="submit" value="Salvar" class="btn btn-info ">
