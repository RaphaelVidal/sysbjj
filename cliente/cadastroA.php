		...
		<br>
				<div class="row">
					...
					<div class="card card-signup">
							...
							<form class="formuser" method="POST" enctype="multipart/form-data" action="update.php" >
	...
	<br>
			...
			<table id="cad_table" >
				...
				<input align="center" type="submit" value="Salvar" class="btn btn-info ">
					...
					<a href="../cliente/conteudo.php?cpf=<?php echo $cpf?>"><input type="button" value="Cancelar" class="btn btn-info " id="btnCancelar">
