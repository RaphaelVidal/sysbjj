...
<html>
    ...
    <link href="../assets/css/material-kit.css" rel="stylesheet"/>
		...
		<script>
			...
			alert("Preencha a certidão de nascimento apenas com os números ex: 20666901552012163734067143002945");
		</script>
	</head>
	...
	<br>
		...
		<form name="formuser" action="processa_cad_usuario.php" method="POST">
			<table id="cad_table" border="1" class=" btn-lg text-right" >
				<tr>
					<td class="btn-lg text-right">Certidão de nascimento: </td>
					<td width="500" align="left"><input required type="text" name="cpf" class=""  placeholder="Utilize só numeros!"  maxlength="90" size="40"></td>
				</tr>
				
				<tr>
					<td class="btn-lg text-right">E-mail :</td>
					<td align="left"><input required type="text" name="email" class="txt" ></td>
				</tr>	
				
				<tr>
					<td class="btn-lg text-right">Senha :</td>
					<td align="left"><input required type="password" name="senha" class="txt"></td>
				</tr>
				
				<tr>
					<td class="btn-lg text-right">Repetir Senha :</td>
					<td align="left"><input required type="password" name="rep_senha" class="txt"></td>	
				</tr>
